def Profile(driver, result):
    ...
    Profile["General"]["Solde"] = str(driver.find_element_by_xpath(
        '//*[@id="alliance_profile_statistiques_general_infos"]/tbody/tr[2]/td[2]/div/span[2]/span').text.replace(" ", "").replace("$", ""))
    Profile["General"]["BeneficeHebdo"] = str(driver.find_element_by_xpath(
    ...
    Profile["Hub"]["KmPartage"] = float(driver.find_element_by_xpath(
