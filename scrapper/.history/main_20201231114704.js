...
(async () => {
  ...
  var a = await page.$('#largeContainer > #mainContainer > #mainContent > #mainContentLeft > #pageContent > #content > #newAirlinesManagerHomePage > #dashboardContent > .moduleArea > .indexModule.companyStats.fr > .content > .line', el => el.textContent)
  //console.log(await page.$('a[title="Trésorerie structurelle à J-1"]'))
  console.log("a:", a.getProperties())
  console.log("end")

  var x = document.querySelectorAll('a[title="Trésorerie structurelle à J-1"]').querySelectorAll("span"); 
