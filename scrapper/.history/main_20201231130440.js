...
(async () => {
  ...
  title = await page.evaluate(() => {
    return document.querySelectorAll ('div[title="Trésorerie structurelle à J-1"]').textContent.trim();
  });
  console.log(title);


  //const dataValues = await page.$$eval('#largeContainer > #mainContainer > #mainContent > #mainContentLeft > #pageContent > #content > #newAirlinesManagerHomePage > #dashboardContent > .moduleArea > .indexModule.companyStats.fr > .content');
