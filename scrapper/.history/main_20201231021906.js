...
(async () => {
    ...
    console.log(await page.$('#largeContainer > #mainContainer > #mainContent > #mainContentLeft > #pageContent > #content > #newAirlinesManagerHomePage > #dashboardContent > .moduleArea > .indexModule.companyStats.fr > .content > .line', el =>console.log( el.value)))
