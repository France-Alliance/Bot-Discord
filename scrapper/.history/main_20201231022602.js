...
(async () => {
    ...
    await page.$('#largeContainer > #mainContainer > #mainContent > #mainContentLeft > #pageContent > #content > #newAirlinesManagerHomePage > #dashboardContent > .moduleArea > .indexModule.companyStats.fr > .content > .line', el =>console.log("value: ",el.textContent))
